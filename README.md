...
Btw, if you want a ridiculously easy way to run Qwik as a NodeJS server on a dedicated box for super cheap (with a nice free tier to tinker!) and with ridiculously good DX, check out Railway at https://railway.app (not a paid promotion 😝 just a very satisfied customer).
